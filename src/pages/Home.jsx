            ...
            <div className="bg-[#004f32]">
                ...
                <div className="col-span-3 text-center py-6 flex flex-col items-center justify-center p-4 md:p-2">
                        ...
                        <h2 className="text-white font-bold text-2xl md:text-[2.15em]">
                            Choose the Best of the Best with AI
                        </h2>
                        {/* <button className="rounded-full bg-black hover:bg-yellow text-white w-fit py-2 sm:py-3 px-3 sm:px-4 mt-5 lg:mt-14">
                            <p className="font-semibold text-sm ">
                                LetGo AI
                            </p>
                        </button> */}
                        
                        <button type="button" className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" style={{margin: "1rem", borderRadius: "2.5rem"}} onClick={()=>{ window.location.href = "https://www.buildai.space/app/lets-go-ai-app"}}><strong>LetsGo AI</strong></button>
